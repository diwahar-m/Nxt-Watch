...
export const Left = styled.div`
  ...
  @media screen and (min-width: 768px) {
    ...
    background-color: ${props => (props.darker ? ' #475569' : '#ffffff')}
    width: 25vw;
    height: 100vh;
  }
`
...
export const Right = styled.div`
  display: flex;
  width: 75vw;
  background-color: ${props => (props.darker ? '  #181818' : '#ffffff')};
  color: ${props => (props.darker ? '  #ffffff' : '  #181818')};
  flex-direction: column;
